...
public class eSpeakActivityOld extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        if (item.getItemId() == R.id.espeakSettings) {
            startActivityForResult(new Intent(eSpeakActivityOld.this, TtsSettingsActivity.class), REQUEST_DEFAULT);
            return true;
    ...
    private static class EspeakHandler extends Handler {
    	private WeakReference<eSpeakActivityOld> mActivity;

    	public EspeakHandler(eSpeakActivityOld activity)
    	{
    		mActivity = new WeakReference<eSpeakActivityOld>(activity);
    	}
